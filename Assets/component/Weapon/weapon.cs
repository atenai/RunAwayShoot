...
{
    //持てる総弾数
    [SerializeField] protected private uint mMaxBullet;
    //残弾数（手持ち）
    [SerializeField] protected private uint mRemainderBulletContet;
    //マガジンの総弾数
    [SerializeField] protected private uint mMaxBulletMagazine;
    //残弾数（マガジン）
    [SerializeField] protected private uint mRemainderBulletMagazine;

    //レート
    [SerializeField] protected private float mShootSpeed;

    //　弾そのもの
    [SerializeField] protected private GameObject mBulletPrefab;

    //前ベクトル保管
    [SerializeField] protected private GameObject mFrontVec;
