...
namespace InitializeData
{
    public class InitializeDataList : MonoBehaviour
    {
        ...
        {
            [SerializeField] private static float MaxHP = 100;
            [SerializeField] private static float AssultDamege = 30;
        ...
        {
            [SerializeField] private static float MaxHP = 120;
            [SerializeField] private static float BulletDamege = 10;
